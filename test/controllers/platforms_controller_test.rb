...
class PlatformsControllerTest < ActionController::TestCase
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post :create, platform: { company: @platform.company, end: @platform.end, name: @platform.name, start: @platform.start }
    end
  ...
  test "should update platform" do
    patch :update, id: @platform, platform: { company: @platform.company, end: @platform.end, name: @platform.name, start: @platform.start }
    assert_redirected_to platform_path(assigns(:platform))
  end
