...
class PeliculasControllerTest < ActionController::TestCase
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post :create, pelicula: { country: @pelicula.country, director: @pelicula.director, name: @pelicula.name, year: @pelicula.year }
    end
  ...
  test "should update pelicula" do
    patch :update, id: @pelicula, pelicula: { country: @pelicula.country, director: @pelicula.director, name: @pelicula.name, year: @pelicula.year }
    assert_redirected_to pelicula_path(assigns(:pelicula))
  end
